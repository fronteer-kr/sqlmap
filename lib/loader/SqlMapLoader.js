...
var SqlMapListener = require("../parser/SqlMapListener");
var SqlMapVisitor = require("../parser/SqlMapVisitor");
...
function loadSqlMapFile(fileName, sqlMap, callback) {
    ...
    context.check();
    if(util.isFunction(callback)) callback(null, sqlMap, [path.resolve(fileName)]);
