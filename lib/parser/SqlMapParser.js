...
var ruleNames =  [ "root", "sqlDef", "defLine", "includeLine", "include", 
                   "textLine", "sqlType", "param", "sqlId" ];
...
SqlMapParser.RULE_include = 4;
SqlMapParser.RULE_textLine = 5;
SqlMapParser.RULE_sqlType = 6;
...
RootContext.prototype.NL = function() {
...
SqlMapParser.prototype.include = function() {
    ...
    this.enterRule(localctx, 8, SqlMapParser.RULE_include);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 42;
...
TextLineContext.prototype.SQLID = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
        return this.getTokens(SqlMapParser.SQLID);
    } else {
        return this.getToken(SqlMapParser.SQLID, i);
    }
};


TextLineContext.prototype.WS = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
        return this.getTokens(SqlMapParser.WS);
    } else {
        return this.getToken(SqlMapParser.WS, i);
    }
};
...
SqlMapParser.prototype.textLine = function() {
    ...
    this.enterRule(localctx, 10, SqlMapParser.RULE_textLine);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 50;
        this._errHandler.sync(this);
...
SqlMapParser.prototype.sqlType = function() {
    ...
    this.enterRule(localctx, 12, SqlMapParser.RULE_sqlType);
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 55;
...
SqlIdContext.prototype.WS = function(i) {
	if(i===undefined) {
		i = null;
	}
    if(i===null) {
